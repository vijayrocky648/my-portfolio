      ...
      <div className="w-100 h-100">
        <div className="row align-items-center" style={{height:"20%"}}>
          <div className="col-md-12">
            ...
            <div
              className="underLine"
              data-aos="fade-right"
              style={{ background: "rgb(230, 9, 101)" }}
            ></div>
          </div>
        </div>
        <div className="row  align-items-center" style={{height:"80%"}}>
          ...
          >
            ...
            <p className="aboutme">
              I'm a <b>FullStack Developer</b> from Chennai in India, I have
              serious passion for UI effects, animations and creating intuitive,
              dynamic user experiences. Let's make something special.
            </p>
          </div>
          <div
            className="offset-md-1 col-md-5 p-4"
